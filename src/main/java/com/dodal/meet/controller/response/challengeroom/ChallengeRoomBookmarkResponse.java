...
@Getter
@Setter
@Schema(description = "북마크 조회 응답")
@JsonNaming(value = PropertyNamingStrategy.SnakeCaseStrategy.class)
@ToString
public class ChallengeRoomBookmarkResponse {
    ...
    @QueryProjection
    public ChallengeRoomBookmarkResponse(Integer challengeRoomId, Long hostId, String hostNickname, String hostProfileUrl, String title, String content, int certCnt, String thumbnailImgUrl, int recruitCnt, int userCnt, String categoryName, String categoryValue, String tagName, String tagValue) {
